...
const week = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
const hasDaysLongerThanSixLetters = function(element) {
...
const filteredDaysLongerThanSixLetters =  function(element){
   return element.length>6;
}
console.log(week.filter(filteredDaysLongerThanSixLetters));
...
const arrayOfCapitalizedDays = function(element) {
  return element.toUpperCase();
}
console.log(week.map(arrayOfCapitalizedDays));

//OR using REFACTOR function
/*const arrayOfCapitalizedDays = week.map(element=>element.toUpperCase());
